                             ...
                             <div class="col-md-6" data-aos="fade">
                                <article class="blog-post">
                                    <div class="post-slider slider-sm rounded">
                                        <img loading="lazy" decoding="async" src="https://picsum.photos/200"
                                            alt="Post Thumbnail">

                                    </div>
                                    <div class="pt-4">
                                        <p class="mb-3">{{ $article->created_at->format('d M, Y') }}</p>
                                        <h2 class="h4"><a wire:navigate class="text-black" href="{{ route('blog.details',$article->id) }}">{{ $article->title }}</a></h2>
                                        <p>{{ $article->content }}</p> <a wire:navigate href="{{ route('blog.details',$article->id) }}" class="text-primary fw-bold"
                ...
                <div class="col-lg-3">
                    ...
                    <div class="widget widget-categories">
                        ...
                        <ul class="list-unstyled widget-list">
                            ...
                            <li><a wire:navigate href="{{ route('blog').'?categorySlug='.$cat->slug }}">{{ $cat->name }} <small class="ml-auto">(1)</small></a>
                            </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="widget">
                        ...
                        @foreach ($latesArticles as $article)
                          <!-- post-item -->
                        <ul class="list-unstyled widget-list">
                            <li class="d-flex widget-post align-items-center">
                                <a wire:navigate class="text-black" href="{{ route('blog.details',$article->id) }}">
                                    <div class="widget-post-image flex-shrink-0 me-3">
                                        <img class="rounded" loading="lazy" decoding="async"
                                            src="https://picsum.photos/200" alt="Post Thumbnail">
                                    </div>
                                </a>
                                <div class="flex-grow-1">
                                    <h5 class="h6 mb-0"><a class="text-black" href="blog-details.html">{{ $article->title }}</a></h5>
